...
public:
    constexpr static bool value =
            std::is_same_v<T, first> || Has<T, rest>::value;
};
...
//  ------------------------------------------------------------------------------------------
    ...
    using TestDeque = Deque<int, double, char, float>;

    static_assert(has_v<int, TestDeque>, "int should be found in deque");
    static_assert(has_v<double, TestDeque>, "double should be found in deque");
    static_assert(has_v<char, TestDeque>, "char should be found in deque");

    static_assert(!has_v<bool, TestDeque>, "bool should not be found in deque");

    static_assert(!has_v<int, Deque<>>, "empty deque");
    static_assert(!has_v<double, Deque<>>, "empty deque");

    static_assert(has_v<int, Deque<int>>, "int should be found in deque");
    static_assert(!has_v<double, Deque<int>>, "double should not be found in deque");

    struct CustomType {};
    using CustomDeque = Deque<CustomType, int>;
    static_assert(has_v<CustomType, CustomDeque>, "CustomType should be found in deque");
    static_assert(!has_v<double, CustomDeque>, "double should not be found in custom deque");
}
